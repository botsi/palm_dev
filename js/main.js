        ...
        if (xmlhttp.readyState == 4) {
            ...
            if (xmlhttp.status == 200) {
                ...
                for (var key in obj) {
                    ...
                    var a = (isNaN(key)) ? 'href="' + u + key + '.pdf" download="' + folders[chapter].data[folders[chapter].last_position].name.replace(/\./g, "").replace(/\!/g, "").replace(/\?/g, "").replace(/\,/g, "_").replace(/ \- /g, "_").replace(/ /g, "_") + '_' + obj[key][1].replace(/ /g, "_") + '_' + obj[key][2].replace(/ /g, "_") + '.pdf"' : 'onclick="parent_media(this,' + key + ')"';
